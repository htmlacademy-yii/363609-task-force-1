...
$items = [
        [
        'label' => 'Завершённые', 'url' => ['user-task/completed'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--completed'],
        'template' => '<div class="menu-toggle__svg-wrapper">
    ...
    [
        'label' => 'Новые', 'url' => ['user-task/index'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--new'],
        'template' => '<div class="menu-toggle__svg-wrapper">
    ...
    [
        'label' => 'Активные', 'url' => ['user-task/in-work'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--active'],
        'template' => '<div class="menu-toggle__svg-wrapper">
    ...
    [
        'label' => 'Отменённые', 'url' => ['user-task/canceled'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--canceled'],
        'template' => '<div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    [
        'label' => 'Просроченные', 'url' => ['user-task/expired'], 'options' => ['class' => 'menu-toggle__item menu-toggle__item--hidden'],
        'template' => '<div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<section class="menu-toggle">
    ...
    echo Menu::widget(
        [
            'items' => $items,
            'options' => [
                'class' => 'menu-toggle__list',
            ],
            'activeCssClass'=>'menu_toggle__item--current'
        ]
    );?>
</section>
